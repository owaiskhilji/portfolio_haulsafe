    ...
    <section className="py-20 px-4 bg-primary">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mt-4 inline-flex items-center gap-2 text-gray-300 text-sm">
            ...
            <div className="relative space-y-8">
              ...
              {referralSteps.map((step, index) => (
                ...
                >
                  ...
                  {/* Content */}
                  <div className="flex-1 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 hover:border-secondary/30 transition-all">
          ...
          >
            ...
            <div className="space-y-6">
              {earningScenarios.map((scenario, index) => (
                <motion.div
                  key={index}
                  className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 hover:border-secondary/30 transition-all"
                  initial={fadeInRight.initial}
                  whileInView={fadeInRight.animate}
                  viewport={{ once: true, amount: 0.2 }}
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-secondary/10 rounded-lg p-4 text-center">
                      <p className="text-gray-300 text-sm mb-1">Monthly</p>
                      <p className="text-2xl font-extrabold text-secondary">
                        {scenario.monthly}
                      </p>
                    </div>
                    <div className="bg-secondary/10 rounded-lg p-4 text-center">
                      <p className="text-gray-300 text-sm mb-1">Annual</p>
                      <p className="text-2xl font-extrabold text-secondary">
                        {scenario.annual}
                      </p>
                    </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/50 rounded-xl p-6 border-2 border-primary/20">
                <p className="text-primary font-semibold mb-2">
                  Win-Win
                </p>
                <p className="text-primary/80">
